...
public class ChangeCommandHandler implements CommandHandler {
    ...
    public ChangeCommandHandler(OpenCommandHandler openCommandHandler) {
    ...
    public void handleCommand(String command) {
        if (command.startsWith("change")) {
            if (openCommandHandler.isFileOpened()) {
                // Имплементация за промяна на данни за събитие
                System.out.println("Успешно променени данни за събитие.");
            } else {
